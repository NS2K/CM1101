...
def print_menu(exits):
    ...
    if is_valid_exit(exits, "west"):
       print_menu_line("west", exit_leads_to(exits, "west"))

    if is_valid_exit(exits, "north"):      
       print_menu_line("north", exit_leads_to(exits, "north"))

    if is_valid_exit(exits, "east"):      
       print_menu_line("east", exit_leads_to(exits, "east"))

    if is_valid_exit(exits, "south"):      
       print_menu_line("south", exit_leads_to(exits, "south"))
